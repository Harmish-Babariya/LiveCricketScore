...
export const StateProvider = ({children}) => {
    ...
    // addToBasket = ({ id:res.id }) -> function call from Product.js file
    //  addToBasket = ({ id }) -> function definition from StateProvider.js file

    const addPlayerData = ({ livedata }) => {
        // console.log("state Provier :- ",(livedata.brun1)/(livedata.bover1));
        dispatch({
